...
CORE_PACKAGES=(bash calcurse cargo ctags command-not-found curl docker docker-compose fzf highlight htop neofetch neovim nodejs npm python3 py3-pip ripgrep tmux tree zsh) # stow navi ncmpcpp sxhkd
GRAPHICAL_PACKAGES=()
