...
CORE_PACKAGES=(bash calcurse cargo ctags command-not-found docker docker-compose fzf highlight htop neofetch neovim nodejs npm python3 py3-pip ranger ripgrep tmux tree zsh) # stow navi ncmpcpp sxhkd
GRAPHICAL_PACKAGES=()
