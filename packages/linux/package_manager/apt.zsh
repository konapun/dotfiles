...
CORE_PACKAGES=(bat calcurse cargo clojure command-not-found docker docker-compose fortune-mod fzf gh golang gron highlight htop hub leiningen luarocks neofetch nodejs python3 python3-pip ripgrep thefuck tmux universal-ctags tree zsh) # stow navi ncmpcpp sxhkd
