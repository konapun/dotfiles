...
CORE_PACKAGES=(bat calcurse cargo clojure cmatrix command-not-found docker docker-compose fortune-mod fzf gh golang gron guile highlight htop hub jq leiningen luarocks neofetch nodejs python3 python3-pip ripgrep sqlite3 libsqlite3-dev thefuck tmux tree zsh) # stow navi ncmpcpp sxhkd
