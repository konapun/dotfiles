...
CORE_PACKAGES=(bat calcurse cargo clojure ctags command-not-found fzf gron highlight htop leiningen neofetch neovim nodejs python3 python3-pip ranger ripgrep thefuck tmux tree zsh) # stow navi ncmpcpp sxhkd
