...
CORE_PACKAGES=(bat clojure ctags command-not-found fzf gron highlight htop leiningen neofetch neovim nodejs python3 python3-pip ranger ripgrep thefuck tmux tree yarn zsh) # stow navi ncmpcpp sxhkd
