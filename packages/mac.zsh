...
CORE_PACKAGES=(bat calcurse ctags docker fortune fzf gh golang gron gsed guile highlight htop hub luarocks lsd navi neofetch neovim node ripgrep rust thefuck tmux) # babashka stow
