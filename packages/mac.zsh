...
CORE_PACKAGES=(babashka bat calcurse ctags docker fortune fzf golang gron gsed highlight htop hub lsd navi neofetch neovim node ripgrep rust thefuck tmux) # stow
