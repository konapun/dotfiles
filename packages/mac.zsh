...
CORE_PACKAGES=(asdf bat calcurse clisp fzf gh golang gron gsed highlight htop hub lazygit luarocks lsd navi neofetch neovim node ripgrep roswell rust thefuck tmux) # babashka docker fortune guile stow
