...
CORE_PACKAGES=(babashka bat calcurse ctags docker fortune fzf gh golang gron gsed highlight htop hub luarocks lsd navi neofetch neovim node ripgrep rust thefuck tmux) # stow
