...
CORE_PACKAGES=(bat calcurse clisp ctags fzf gh golang gron gsed highlight htop hub luarocks lsd navi neofetch neovim node racket ripgrep roswell rust thefuck tmux) # babashka docker fortune guile stow
