...
CORE_PACKAGES=(babashka bat calcurse ctags docker fortune fzf golang gron gsed highlight htop hub luarocks lsd navi neofetch neovim node ripgrep rust thefuck tmux) # stow
