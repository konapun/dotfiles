...
CORE_PACKAGES=(asdf bat calcurse clisp ctags fzf gh golang gron gsed highlight htop hub luarocks lsd navi neofetch neovim node ripgrep roswell rust thefuck tmux) # babashka docker fortune guile stow
