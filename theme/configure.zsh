...
# Theme nvim
themer_substitute syntax_theme_plug_author $SYNTAX_THEME_PLUG_AUTHOR $NVIM_CONFIG_FILE
themer_substitute syntax_theme_plug_theme $SYNTAX_THEME_PLUG_THEME $NVIM_CONFIG_FILE
