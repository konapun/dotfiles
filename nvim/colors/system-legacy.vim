" -----------------------------------------------------------------------------
" Name:         System
" Description:  Configurable template for system colors
" Author:       konapun
" License:      MIT
" -----------------------------------------------------------------------------
...
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'system', {})
let s:configuration.transparent_background = get(g:, 'system_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'system_disable_italic_comment', 0)
let s:configuration.enable_italic_string = get(g:, 'system_enable_italic_string', 0)
let s:configuration.enable_italic = get(g:, 'system_enable_italic', 0)
let s:configuration.enable_bold = get(g:, 'system_enable_bold', 1)
let s:configuration.cursor = get(g:, 'system_cursor', 'auto')
let s:configuration.current_word = get(g:, 'system_current_word', get(g:, 'system_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
      ...
      \ 'bg_blue':       ['{{bright_blue}}',   '17',   'DarkBlue'],
      \ 'fg':            ['{{foreground}}', '223', 'White'],
      \ 'black':         ['{{black}}', '235', 'Black'],
      \ 'red':           ['{{red}}', '167', 'Red'],
      \ 'green':         ['{{green}}', '108', 'Green'],
      \ 'yellow':        ['{{yellow}}', '214', 'Yellow'],
      \ 'blue':          ['{{blue}}', '109', 'Blue'],
      \ 'purple':        ['{{purple}}', '175', 'Magenta'],
      \ 'cyan':          ['{{cyan}}', '108', 'Cyan'],
      \ 'white':         ['{{white}}', '245', 'White'],
      \ 'bright_black':  ['{{bright_black}}', '235', 'Black'],
      \ 'bright_red':    ['{{bright_red}}', '167', 'Red'],
      \ 'bright_green':  ['{{bright_green}}', '108', 'Green'],
      \ 'bright_yellow': ['{{bright_yellow}}', '214', 'Yellow'],
      \ 'bright_blue':   ['{{bright_blue}}', '109', 'Blue'],
      \ 'bright_purple': ['{{bright_purple}}', '175', 'Magenta'],
      \ 'bright_cyan':   ['{{bright_cyan}}', '108', 'Cyan'],
      \ 'bright_white':  ['{{bright_white}}', '245', 'White'],
      \ 'grey':          ['{{bright_black}}',   '245',  'LightGrey'],
      \ 'light_grey':    ['{{bright_black}}',   '245',  'LightGrey'],
      \ 'none':          ['NONE',      'NONE', 'NONE'],
      \ }
...
call s:HL('Visual', s:palette.bg0, s:palette.bright_yellow)
call s:HL('VisualNOS', s:palette.bg0, s:palette.bright_yellow, 'underline')
...
if s:configuration.enable_bold
  call s:HL('StorageClass', s:palette.bright_yellow, s:palette.none, 'bold')
  call s:HL('Title', s:palette.bright_yellow, s:palette.none, 'bold')
  ...
  call s:HL('StorageClass', s:palette.bright_yellow, s:palette.none)
  call s:HL('Title', s:palette.bright_yellow, s:palette.none)
...
call s:HL('Tag', s:palette.bright_yellow, s:palette.none)
call s:HL('Label', s:palette.bright_yellow, s:palette.none)
call s:HL('Structure', s:palette.bright_yellow, s:palette.none)
call s:HL('Operator', s:palette.bright_yellow, s:palette.none)
...
if s:configuration.transparent_background
  ...
  call s:HL('OrangeSign', s:palette.bright_yellow, s:palette.none)
  ...
  call s:HL('OrangeSign', s:palette.bright_yellow, s:palette.bg1)
...
call s:HL('markdownH2', s:palette.bright_yellow, s:palette.none, 'bold')
...
call s:HL('htmlH2', s:palette.bright_yellow, s:palette.none, 'bold')
...
call s:HL('helpHeader', s:palette.bright_yellow, s:palette.none, 'bold')
...
" }}}
" junegunn/vim-plug{{{
call s:HL('plug1', s:palette.bright_yellow, s:palette.none, 'bold')
...
call s:HL('Lf_hl_match4', s:palette.bright_yellow, s:palette.none, 'bold')
...
if !exists('g:rbpt_colorpairs')
  let g:rbpt_colorpairs = [['blue', s:palette.blue[0]], ['magenta', s:palette.purple[0]],
        \ ['red', s:palette.red[0]], ['166', s:palette.bright_yellow[0]]]
endif

let g:rainbow_guifgs = [ s:palette.bright_yellow[0], s:palette.red[0], s:palette.purple[0], s:palette.blue[0] ]
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  ...
  let s:terminal = {
        ...
        \ 'bright_black':  s:palette.bright_black,
        \ 'bright_red':    s:palette.bright_red,
        \ 'bright_yellow': s:palette.bright_yellow,
        \ 'bright_green':  s:palette.bright_green,
        \ 'bright_cyan':   s:palette.bright_cyan,
        \ 'bright_blue':   s:palette.bright_blue,
        \ 'bright_purple': s:palette.bright_purple,
        \ 'bright_white':  s:palette.bright_white
        \ }
  " Implementation: {{{
  if !has('nvim')
    let g:terminal_ansi_colors = [s:terminal.black[0], s:terminal.red[0], s:terminal.green[0], s:terminal.yellow[0],
          \ s:terminal.blue[0], s:terminal.purple[0], s:terminal.cyan[0], s:terminal.white[0], s:terminal.bright_black[0], s:terminal.bright_red[0],
          \ s:terminal.bright_green[0], s:terminal.bright_yellow[0], s:terminal.bright_blue[0], s:terminal.bright_purple[0], s:terminal.bright_cyan[0], s:terminal.bright_white[0]]
  else
    ...
    let g:terminal_color_9  = s:terminal.bright_red[0]
    let g:terminal_color_10 = s:terminal.bright_green[0]
    let g:terminal_color_11 = s:terminal.bright_yellow[0]
    let g:terminal_color_12 = s:terminal.bright_blue[0]
    let g:terminal_color_13 = s:terminal.bright_purple[0]
    let g:terminal_color_14 = s:terminal.bright_cyan[0]
