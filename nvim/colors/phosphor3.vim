" -----------------------------------------------------------------------------
" Name:         Phosphor
" Description:  Phosphorescent colors based on the miramare config
" Author:       konapun
" License:      MIT
" -----------------------------------------------------------------------------
...
" Configuration: {{{
let s:configuration = {}
let s:configuration.palette = get(g:, 'phosphor', {})
let s:configuration.transparent_background = get(g:, 'phosphor_transparent_background', 0)
let s:configuration.disable_italic_comment = get(g:, 'phosphor_disable_italic_comment', 0)
let s:configuration.enable_italic_string = get(g:, 'phosphor_enable_italic_string', 0)
let s:configuration.enable_italic = get(g:, 'phosphor_enable_italic', 0)
let s:configuration.enable_bold = get(g:, 'phosphor_enable_bold', 1)
let s:configuration.cursor = get(g:, 'phosphor_cursor', 'auto')
let s:configuration.current_word = get(g:, 'phosphor_current_word', get(g:, 'phosphor_transparent_background', 0) == 0 ? 'grey background' : 'bold')
" }}}
" Palette: {{{
let s:palette = {
      \ 'bg0':        ['#00010a',   '235',  'Black'],
      \ 'bg1':        ['#002520',   '236',  'DarkGrey'],
      \ 'bg2':        ['#002520',   '237',  'DarkGrey'],
      \ 'bg3':        ['#002520',   '238',  'DarkGrey'],
      \ 'bg4':        ['#002520',   '239',  'Grey'],
      \ 'bg_red':     ['#003c29',   '52',   'DarkRed'],
      \ 'bg_green':   ['#005036',   '22',   'DarkGreen'],
      \ 'bg_blue':    ['#003424',   '17',   'DarkBlue'],
      \ 'fg':         ['#00ff92',   '223',  'White'],
      \ 'red':        ['#008159',   '167',  'Red'],
      \ 'orange':     ['#00b67c',   '208',  'Red'],
      \ 'yellow':     ['#00f7aa',   '214',  'Yellow'],
      \ 'green':      ['#00db96',   '108',  'Green'],
      \ 'cyan':       ['#00a571',   '108',  'Cyan'],
      \ 'blue':       ['#004932',   '109',  'Blue'],
      \ 'purple':     ['#00554a',   '175',  'Magenta'],
      \ 'grey':       ['#006747',   '245',  'LightGrey'],
      \ 'light_grey': ['#007751',   '245',  'LightGrey'],
      \ 'gold':       ['#00f7aa',   '214',  'Yellow'],
      \ 'none':       ['NONE',      'NONE', 'NONE']
      \ }
