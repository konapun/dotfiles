...
NVIM_THEME_FILE=~/.config/nvim/lua/theme.lua
...
themer_substitute accent $ACCENT $NVIM_THEME_FILE
...
themer_substitute left_separator $LEFT_SEPARATOR $NVIM_THEME_FILE
themer_substitute right_separator $RIGHT_SEPARATOR $NVIM_THEME_FILE
themer_substitute left_segment_separator $LEFT_SEGMENT_START $NVIM_THEME_FILE
themer_substitute right_segment_separator $RIGHT_SEGMENT_START $NVIM_THEME_FILE
